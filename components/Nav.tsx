    ...
    <header className="sticky top-0 z-40 border-b border-white/5 bg-[#07131c]/75 backdrop-blur-xl">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
        ...
        <nav className="flex items-center gap-2 text-sm">
          <Link href="/spots" className="rounded-full bg-gold px-4 py-2 font-semibold text-ink hover:bg-[#f0d48a]">Places</Link>
          <Link href="/dashboard" className="rounded-full px-4 py-2 text-sand/80 hover:bg-white/5 hover:text-sand">Town pulse</Link>
        </nav>
      </div>
    </header>
  );
