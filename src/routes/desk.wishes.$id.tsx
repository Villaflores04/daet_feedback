...
export const Route = createFileRoute("/desk/wishes/$id")({
...
function WishDetail() {
  ...
  return (
    <article className="mx-auto max-w-xl">
      <Link to="/desk/wishes" className="inline-flex h-11 items-center text-sm text-action">
        All wishes
      </Link>
